(custom-set-variables
 ...
 '(package-selected-packages
   '(tuareg naysayer-theme typescript-mode yaml-mode xah-fly-keys xah-find which-key use-package try toml-mode rust-mode git-commit company command-log-mode)))
