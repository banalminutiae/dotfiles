...
(custom-set-variables
 ...
 '(package-selected-packages
   '(eldoc fsharp-mode csharp-mode magit xah-find ample-theme rust-mode toml-mode go-mode command-log-mode command-log dashboard xah-fly-keys which-key use-package try))
