...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (magit multiple-cursors rand-theme foggy-night-theme xah-find color-theme-sanityinc-tomorrow ample-theme afternoon-theme soothe-theme flatland-theme rust-mode toml-mode go-mode minsk-theme creamsody-theme naysayer-theme command-log-mode command-log yasnippet-snippets nord-theme moe-theme plan9-theme solarized-theme gruvbox-theme darktooth-theme dashboard xah-fly-keys which-key use-package try)))
